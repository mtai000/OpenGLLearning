...
Eigen::Matrix4f Lesson01::get_view_matrix(Eigen::Vector3f eye_pos)
{
...
Eigen::Matrix4f Lesson01::get_projection_matrix(float eye_fov, float aspect_ratio,
...
int Lesson01::run(int argc, const char** argv)
{
    float angle = 0;
