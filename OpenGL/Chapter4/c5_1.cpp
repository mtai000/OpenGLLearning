...
void Chapter5_1::setupVertices(void)
{
...
void Chapter5_1::init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("GLSL/5_1/vertShader.glsl", "GLSL/5_1/fragShader.glsl");
	...
	brickTexture = Utils::loadTexture("GLSL/5_1/brick1.jpg");
	// SEE Utils.cpp, the "loadTexture()" function, the code before the mipmapping section
}

void Chapter5_1::display(GLFWwindow* window, double currentTime) {
